        ...
        <aside class="sidebar">
            <ul>
                ...
                <a href="studentreg.html">
                    <li><i class="fa-solid fa-user-plus"></i> Register Student</li>
                </a>
                <a href="room_availability.html">
                    <li><i class="fa-solid fa-bed"></i> Room Availability</li>
                </a>
                <a href="daily_expense.html">
                    <li><i class="fa-solid fa-money-bill-wave"></i> Daily Expense</li>
                </a>
                <a href="profit.html">
                    <li><i class="fa-solid fa-chart-line"></i> Profit</li>
                </a>
                <a href="search_student.html">
                    <li><i class="fa-solid fa-search"></i> Search Student</li>
                </a>
                <a href="light_bill.html">
                    <li><i class="fa-solid fa-lightbulb"></i> Light Bill Calculation</li>
                </a>
                <a href="notice_board.html">
                    <li><i class="fa-solid fa-sticky-note"></i> Notice Board</li>
                </a>
                <a href="wifi_management.html">
                    <li><i class="fa-solid fa-wifi"></i> WiFi Password </li>
                </a>
                <a href="students_query.html">
                    <li><i class="fa-solid fa-question-circle"></i>  Query & Doubt</li>
                </a>
